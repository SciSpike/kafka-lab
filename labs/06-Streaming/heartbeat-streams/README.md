# `heartbeat-streams` — build & run

Provided Java for the [heartbeat-streams-lab](../heartbeat-streams-lab.md) lab — the heartbeat monitor in Kafka Streams (changelog-backed state survives restart).
