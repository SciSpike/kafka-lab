# `device-simulator` — build & run

Provided Java for the [topics-and-partitions](../topics-and-partitions.md) lab — produces simulated device heartbeats to `device-heartbeat`.
